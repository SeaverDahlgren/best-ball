...
class Session(models.Model):
    ...
    def __str__(self):
        return f"Session {self.pid}"

class Ball(models.Model):
    color = models.CharField(max_length=50)
    distanceFromHole = models.DecimalField(max_digits=8, decimal_places=3)
    currentPlayer = models.ForeignKey(Player, on_delete=models.CASCADE)
